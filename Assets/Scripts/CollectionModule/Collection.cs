...
[System.Serializable]
public class Collection<T> : ScriptableObject, ICollection, IEnumerable<T> where T : CollectionElement
{
    [SerializeField] private List<T> elements; // Performance: Switch to an HashSet later?
    ...
    {
        return Array.ConvertAll(elements.ToArray(), e => e.Identifier);
    }
